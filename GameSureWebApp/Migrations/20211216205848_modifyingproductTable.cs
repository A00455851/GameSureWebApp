...
{
    public partial class modifyingproductTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProdId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProdPlan = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_AspNetUsers_GameSureWebAppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TxnDetId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionDets", x => x.TxnDetId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_GameSureWebAppUserId",
                table: "Addresses",
